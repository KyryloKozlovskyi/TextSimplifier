...
public class Runner {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * System.out.println(ConsoleColour.WHITE); System.out.println(
		 * "************************************************************"); System.out.
		 * println("*     ATU - Dept. of Computer Science & Applied Physics    *");
		 * System.out.
		 * println("*                                                          *");
		 * System.out.
		 * println("*             Virtual Threaded Text Simplifier             *");
		 * System.out.
		 * println("*                                                          *");
		 * System.out.println(
		 * "************************************************************");
		 ...
		 * System.out.println("(5) Optional Extras..."); System.out.println("(?) Quit");
		 * 
		 * // Output a menu of options and solicit text from the user
		 * System.out.print(ConsoleColour.BLACK_BOLD_BRIGHT);
		 * System.out.print("Select Option [1-4]>"); System.out.println();
		 * 
